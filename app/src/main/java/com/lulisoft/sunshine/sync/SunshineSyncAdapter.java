package com.lulisoft.sunshine.sync;
...
import com.lulisoft.sunshine.BuildConfig;
import com.lulisoft.sunshine.MainActivity;
import com.lulisoft.sunshine.R;
import com.lulisoft.sunshine.Utility;
import com.lulisoft.sunshine.VolleySingleton;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(JSONObject forecastJson, String locationSetting) throws JSONException {
...
//            JSONObject forecastJson = new JSONObject(forecastJsonStr);
            ...
            Log.d(LOG_TAG, "FetchWeather Task Complete. " + inserted + " Inserted");
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, projection, selection, selectionArgs, null);
